...
namespace Swagger.Net
{
    ...
    public class XmlCommentDocumentationProvider : IDocumentationProvider
    {
        ...
        public virtual string GetDefaultValueDescriptionIfAny(HttpParameterDescriptor parameterDescriptor)
        {

            ReflectedHttpParameterDescriptor reflectedParameterDescriptor = parameterDescriptor as ReflectedHttpParameterDescriptor;
            if (reflectedParameterDescriptor != null && reflectedParameterDescriptor.ParameterInfo.IsOptional)
            {
                return "<br /> (Default Value = " + reflectedParameterDescriptor.ParameterInfo.DefaultValue.ToString() + ")";
            }
            else
            {
                return String.Empty;
